...
@interface XLJNewFetureController ()<UICollectionViewDelegate,UICollectionViewDataSource>
...
@implementation XLJNewFetureController
...
- (instancetype)initWithNSArray:(NSMutableArray *)array withButton:(XLJExButton *)startButton
{
    if (self = [super init]) {
        self.mArray = array;
    }
...
- (void)initilizationSub
{
    ...
    //注册cell
    [self.collectionView registerClass:[XLJCollectionViewCell class] forCellWithReuseIdentifier:reuseIdentifier];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    //3.如果没有注册，就注册
    XLJCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:reuseIdentifier forIndexPath:indexPath];
    ...
    LRViewBorderRadius(cell.startButton, 10, 1, ThemeColor);
    //判断是否是最后一页
